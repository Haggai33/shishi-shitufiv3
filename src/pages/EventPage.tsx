    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {categoriesOrder.map(categoryKey => {
          ...
          return (
            <div key={categoryKey} onClick={() => onSelectCategory(categoryKey)} className="relative category-card-2025 p-6 rounded-xl cursor-pointer text-center overflow-hidden">
